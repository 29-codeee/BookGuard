...
describe('App navigation', () => {
  it('renders prototype navigation with AI Planner, Data Library, My Trips, and Transaction Ops', async () => {
    ...
    render(<App />);
    for (const label of ['AI Planner', 'Data Library', 'My Trips', 'Transaction Ops']) {
      expect(screen.getByRole('button', { name: new RegExp(label) })).toBeTruthy();
    }

    // Explore & Book, Trip Sentinel, and Ops & Invariants removed from prototype navigation
    for (const removed of ['Explore & Book', 'Trip Sentinel', 'Ops & Invariants']) {
